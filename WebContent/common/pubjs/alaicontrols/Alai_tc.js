...
//		selBC=bColor==null?"#cacaca":bColor
...
//			tc.setRowStyle(rowStyle);
	...
	tc.mouseOver=function(bColor,fColor)
	{
		...
		var bc=bColor==null?"E0E0E0":bColor
		var rowfc=[],rowbc=[]
		function overRow(tr)
		{
			if(curRow!=null)
    ...
    //Christian于2005。3。25日加入
	tc.removeele=function()
	{tc.ctr.removeNode(true);
	}
