...
var gsBottom="<A href='javascript:void(0)' class='Today' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"Today is not a selectable date!\");return false;' onmouseover='return true;' title='今天'>今天 : "+gToday[0]+" "+gMonths[gToday[1]-1]+" "+gToday[2]+"</A>";	// the content of the bottom section.
