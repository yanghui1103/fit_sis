...
function fHoliday(y,m,d) {
	...
	if (r) return null;	// ignore the following holiday checking if the date has already been set by the above addEvent functions. Of course you can write your own code to merge them instead of just ignoring.
	...
	return null;	// if r is null, the engine will just render it as a normal day.
}
