...
$(function(){
	...
	var array = new Array();
	array[0] = allJlId ;
	createJsonAndAjaxNew('getThisApplyInfoByFlowId.action', array,dealInitCheckTopPage,'json',true  ) ;
});
function dealInitCheckTopPage(data){ 
	...
	$("#minzu",navTab.getCurrentPanel()).val(json[0].person_nation);
	$("#first_date",navTab.getCurrentPanel()).val(json[0].first_date);  
