...
$(function(){
	...
	var allJlId = $("input[name='recId']:checked").val();
	if($("input[name='recId']:checked").length <1){
...
<body>
	...
	<form method="post" action=""  id=createForm class="pageForm required-validate">
		...
		<a class="button checkHis"  target="dialog" rel="dlg_page1005" mask="true" title="审核历史"></a>  
		<a class="button ahrefCss"  target="dialog" rel="dlg_page1010" mask="true" title="附件"><span>附件</span></a> 
		</div>
