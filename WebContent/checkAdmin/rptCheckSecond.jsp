...
<script type="text/javascript"  src="checkAdmin/rptCheckSecond.js"></script>
<script type="text/javascript">
$(document).ready(function(){
	var arr = new Array(60);
	for(var i in arr.length){
		 arr[i] = "-9";		 
	}arr[0] = "301";arr[1] = "navTab"; 
...
<div class="pageFormContent"> 
		<table >
			...
			<td>
				...
				<a   style="float:left"  class="btnLook" href="system/orgStructure_qry.jsp?custom_org_function_id=301&select_org_multi=1&select_cascade='ps'&unselect_cascade=''"   lookupGroup="orgLookup">查找带回</a>		
