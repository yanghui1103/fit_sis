	...
	<div class="pageContent">
		<form method="post" action="" id=createForm
			...
			<div class="pageFormContent" layoutH="116">
				<p>
					<label>申报人姓名：</label> <input id="person_name" name="person_name"
						class="required" type="text" style="float: left" readonly />
				</p>
				<p>
				...
				<p>
					<label>申报人性别：</label> <select id="gender" name="gender" disabled
						style="float: left">
				...
				<p>
					<label>联系电话：</label> <input id="phone" name="phone" type="text"
						style="float: left" maxlength=12 readonly />
				</p>
				<p>
					<label>初次申报日期：</label> <input id="first_date" name="first_date"
						type="text" style="float: left" readonly />
				</p>
				<div class="divider"></div>
				<p>
					<label>就业单位名称：</label> <input id="unit_name" name="unit_name"
						class="required" type="text" readonly style="float: left"
						maxlength=20 />
				</p>
				<p>
				...
				<p>
					<label>补贴类型：</label> <select id="rpt_type" name="rpt_type" disabled
						style="float: left">
					</select>
				</p>
				<p>
				...
				<p>
					<label>票据缴费开始月份：</label> <input id=start_date ename="开始日期"
						name="start_date" type="text" class="date required " disabled
						datefmt='yyyyMM' style="float: left" readonly="true" />
				</p>
				<p>
					<label>票据缴费结束月份：</label> <input id=end_date ename="结束日期"
						name="end_date" type="text" class="date required " disabled
						datefmt='yyyyMM' style="float: left" readonly="true" />
				</p>
				<p>
					<input type="hidden" id="fdid" name="fdid" /> <input
						type="hidden" id="flow_id" name="flow_id" /> <input
						type="hidden" id="pass_type" name="pass_type" value="2" />
			...
			<div class="pageFormContent">
				<div class="divider"></div>
				<p>
					<label>审核结果：</label> <select id="check_result" name="check_result"
						id="check_result" style="float: left">
					</select>
				</p>
				<p>
					<label>审核备注：</label> <input type="text" maxlength=15
						id="check_info" name="check_info" />
				</p>
		</form>
	</div>

	<div style="display: none;">
		<a class="button checkHis" target="dialog" rel="dlg_page115"
			mask="true" title="审核历史"></a> <a class="button ahrefCss"
			target="dialog" rel="dlg_page101" width="700" height="200" title="附件"><span>附件</span></a>
		<a class="button rptedInfos" target="dialog" rel="dlg_page113"
